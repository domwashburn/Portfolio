  ...
  render() {
    return (
      ...
      architecture as polished as the interfaces I’m creating.</p>
        ...
        <main className="body">
        <nav className="socail-links content">
            <a className="socail-links__link" href="https://www.linkedin.com/in/dominick-washburn-0a3b8742/" >
              <svg className="icon--linkedin" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="43px" height="43px" viewBox="0 0 43 43">
                <path class="st0" d="M36.6,36.6h-6.4v-10c0-2.4,0-5.4-3.3-5.4c-3.3,0-3.8,2.6-3.8,5.3v10.1h-6.4V16.1h6.1v2.8H23
            ...
            <a className="socail-links__link"  href="https://github.com/domwashburn" >
              <svg className="socail-links__link" className="icon--github" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="43.9px" height="42.9px" viewBox="0 0 43.9 42.9">
                <path class="st0" d="M22,0C9.8,0,0,9.8,0,22c0,9.7,6.3,17.9,15.1,20.8c1.2,0.1,1.5-0.4,1.5-1V38c-6.2,1.3-7.5-2.9-7.5-2.9
